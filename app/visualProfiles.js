...
export const V080_CARD_READ_CONTRACTS = deepFreeze({
  ...
  engineer: { weaponId: "crossbow", label: "TRAP", role: "controller", accent: "#45d6db" },
});
...
export const V080_UNIT_VISUAL_PROFILES = deepFreeze({
  ...
  engineer: unitProfile({
    unitId: "unit-monkey",
    combatKind: "engineer",
    identityPath: "/art/v070/characters/reference/monkey-base-r11.png",
    identityRevision: "r11",
    eventPath: "/art/v070/characters/portraits/engineer-portrait-v1.webp",
    eventRevision: "r2",
    cardPath: "/art/v0995/characters/cards/monkey-formation-card-r3.webp",
    cardRevision: "r3",
    ...
    focus: { x: .54, y: .2 },
    identityLock: [
      "attractive-26-year-old-japanese-male-face",
      "voluminous-layered-silver-gray-hair",
      "black-and-tan-light-tactical-kit",
      "two-cam-compact-compound-crossbow-with-visible-bolt",
      "rectangular-thigh-trap-cassette",
    ],
  }),
});
...
export const V090_UNIT_VISUAL_PROFILES = deepFreeze({
  zakimiya: unitProfile({
    ...
    identityRevision: "r1",
    eventPath: "/art/v0995/characters/portraits/zakimiya-event-portrait-r2.webp",
    eventRevision: "r2",
    cardPath: "/art/v0995/characters/cards/zakimiya-formation-card-r2.webp",
    cardRevision: "r2",
  ...
  tky: unitProfile({
    unitId: "unit-tky",
    combatKind: "tky",
    identityPath: "/art/v090/characters/reference/tky-identity-master-r1.png",
    identityRevision: "r1",
    eventPath: "/art/v0995/characters/portraits/tky-event-portrait-r2.webp",
    eventRevision: "r2",
    cardPath: "/art/v0995/characters/cards/tky-formation-card-r2.webp",
    cardRevision: "r2",
    battlePath: "/art/v090/characters/tky-battle-r1.png",
    battleRevision: "r1",
    cardRead: V090_CARD_READ_CONTRACTS.tky,
    focus: { x: .5, y: .2 },
    identityLock: [
      "adult-japanese-male-face-and-black-side-parted-hair",
      "lean-build-and-fashion-forward-black-layered-coat",
      "dark-red-magenta-straps-and-arm-accents",
      "original-one-handed-plasma-blade-hilt",
      "white-hot-core-with-pink-magenta-blade-edge",
    ],
  }),
  "mrs-chiha": unitProfile({
    unitId: "unit-mrs-chiha",
    combatKind: "mrs-chiha",
    identityPath: "/art/v090/characters/reference/mrs-chiha-identity-master-r1.png",
    identityRevision: "r1",
    eventPath: "/art/v0995/characters/portraits/mrs-chiha-event-portrait-r2.webp",
    eventRevision: "r2",
    cardPath: "/art/v0995/characters/cards/mrs-chiha-formation-card-r2.webp",
    cardRevision: "r2",
    battlePath: "/art/v090/characters/mrs-chiha-battle-r1.png",
    battleRevision: "r1",
    cardRead: V090_CARD_READ_CONTRACTS["mrs-chiha"],
    focus: { x: .5, y: .2 },
    identityLock: [
      "adult-japanese-woman-face-and-elegant-dark-updo",
      "intelligent-expression-and-slender-build",
      "black-long-coat-white-ruffled-blouse-and-brass-hardware",
      "black-gloves-trousers-and-buckled-heeled-boots",
      "large-rotary-cylinder-grenade-launcher",
    ],
  }),
  "miyamoto-musashi": unitProfile({
    unitId: "unit-miyamoto-musashi",
    combatKind: "miyamoto-musashi",
    identityPath: "/art/v090/characters/reference/miyamoto-musashi-identity-master-r1.png",
    identityRevision: "r1",
    eventPath: "/art/v0995/characters/portraits/miyamoto-musashi-event-portrait-r2.webp",
    eventRevision: "r2",
    cardPath: "/art/v0995/characters/cards/miyamoto-musashi-formation-card-r2.webp",
    cardRevision: "r2",
    battlePath: "/art/v090/characters/miyamoto-musashi-battle-r1.png",
    battleRevision: "r1",
    cardRead: V090_CARD_READ_CONTRACTS["miyamoto-musashi"],
    focus: { x: .5, y: .18 },
    identityLock: [
      "rugged-adult-japanese-male-face-stubble-and-topknot",
      "athletic-build-and-stern-expression",
      "weathered-indigo-kimono-patched-armor-and-radio",
      "wrapped-forearms-legs-and-sandals",
  ...
  "mayo-chan": {
    ...unitProfile({
      ...
      identityRevision: "r1",
      eventPath: "/art/v0995/characters/portraits/mayo-chan-event-portrait-r2.webp",
      eventRevision: "r2",
      cardPath: "/art/v0995/characters/cards/mayo-chan-formation-card-r2.webp",
      cardRevision: "r2",
...
export const EVENT_PORTRAIT_PROFILES = deepFreeze({
  ...Object.fromEntries(Object.entries(V080_UNIT_VISUAL_PROFILES).map(([kind, profile]) => [kind, {
    ...
    crop: kind === "engineer" ? "auto 94%" : "auto 92%",
  }])),
