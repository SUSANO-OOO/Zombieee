...
export const ENEMY_CONTENT = deepFreeze([
  ...
  { id: "mother", displayName: "マザー", aliases: [], aiProfile: "summon", hp: 2600, hpPerWave: 0, speed: 5, damage: 38, range: 78, attackEvery: 1.58, bodyRadius: 44, laneSpeed: 16, abilityPressure: 1.86, spawnClass: "boss", initialAbilityCooldown: 3.8, prototypeStatus: "producer-approved" },
  { id: "ooguchi", displayName: "オオグチ", aliases: [], aiProfile: "charge", hp: 2300, hpPerWave: 0, speed: 13, damage: 74, range: 52, attackEvery: 1.46, bodyRadius: 42, laneSpeed: 48, abilityPressure: 1.9, spawnClass: "boss", initialAbilityCooldown: 3.5, prototypeStatus: "producer-approved" },
  { id: "gairen", displayName: "ガイレン", aliases: [], aiProfile: "base-defense", hp: 3000, hpPerWave: 0, speed: 4, damage: 52, range: 88, attackEvery: 1.66, bodyRadius: 46, laneSpeed: 14, abilityPressure: 1.92, spawnClass: "boss", initialAbilityCooldown: 4.1, prototypeStatus: "producer-approved" },
  { id: "futago", displayName: "フタゴ", aliases: [], aiProfile: "area", hp: 2500, hpPerWave: 0, speed: 9, damage: 44, range: 60, attackEvery: 1.22, bodyRadius: 39, laneSpeed: 34, abilityPressure: 1.88, spawnClass: "boss", initialAbilityCooldown: 3.6, prototypeStatus: "producer-approved" },
  ...
  { id: "red-panther-knife", displayName: "RED PANTHER・ナイフ", aliases: [], aiProfile: "charge", hp: 126, hpPerWave: 6, speed: 31, damage: 28, range: 28, attackEvery: .74, bodyRadius: 12, laneSpeed: 70, abilityPressure: 1.4, spawnClass: "normal", initialAbilityCooldown: .8, prototypeStatus: "producer-approved" },
  { id: "red-panther-shield", displayName: "RED PANTHER・シールド", aliases: [], aiProfile: "support-object", hp: 340, hpPerWave: 12, speed: 8, damage: 30, range: 30, attackEvery: 1.24, bodyRadius: 20, laneSpeed: 18, abilityPressure: 1.62, spawnClass: "heavy", initialAbilityCooldown: 1.2, prototypeStatus: "producer-approved" },
  { id: "red-panther-smg", displayName: "RED PANTHER・SMG", aliases: [], aiProfile: "ranged", hp: 142, hpPerWave: 7, speed: 16, damage: 22, range: 150, attackEvery: 1.18, bodyRadius: 12, laneSpeed: 38, abilityPressure: 1.48, spawnClass: "normal", initialAbilityCooldown: .6, prototypeStatus: "producer-approved" },
  { id: "red-panther-commander", displayName: "RED PANTHER・指揮官", aliases: [], aiProfile: "summon", hp: 290, hpPerWave: 10, speed: 12, damage: 34, range: 164, attackEvery: 1.42, bodyRadius: 18, laneSpeed: 28, abilityPressure: 1.72, spawnClass: "heavy", initialAbilityCooldown: 2.4, prototypeStatus: "producer-approved" },
  { id: "mugarian-president-mutated", displayName: "変異ムガリアン社長", aliases: [], aiProfile: "area", hp: 6200, hpPerWave: 0, speed: 7, damage: 72, range: 68, attackEvery: 1.2, bodyRadius: 48, laneSpeed: 24, abilityPressure: 2.2, spawnClass: "boss", initialAbilityCooldown: 4.8, prototypeStatus: "producer-approved" },
  { id: "takuya-omega", displayName: "TAKUYA-Ω", aliases: [], aiProfile: "charge", hp: 9200, hpPerWave: 0, speed: 10, damage: 88, range: 62, attackEvery: 1.34, bodyRadius: 60, laneSpeed: 34, abilityPressure: 2.4, spawnClass: "boss", initialAbilityCooldown: 4.2, prototypeStatus: "producer-approved" },
]);
