...
export const CAMPAIGN_UNITS = deepFreeze([
  ...
  },
  {
    ...
    roleName: "罠師",
    roleIcon: "工",
    weaponName: "二カム式コンパクトクロスボウ・罠装置",
    attackMode: "ボルト射撃・自動足止め装置",
    rangeBand: "中距離",
    primaryTarget: "高速型・侵入経路",
    deploymentHint: "守る戦線の後方へ配備",
    description: "コンパクトクロスボウと足止め装置で敵の進行を妨害する",
    spritePath: "/art/v070/characters/engineer-battle-v1.png",
    assetStatus: "approved",
    appearanceAudit: {
      presentation: "銀灰色の髪、黒とtanの軽装、俊敏な低姿勢の罠師表現",
      weaponMatch: "左右二cam、一本のbowstring、bolt rail、blunt-tip boltを持つコンパクトクロスボウ、腿の罠装置",
      result: "producer-approved V070 r11 identity／portrait／r4 battle atlasへ復帰し同一性を固定",
    },
