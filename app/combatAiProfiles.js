...
export const ENEMY_AI_PROFILES = deepFreeze({
  ...
  "sonic-cone": {
    ...
    humanPursuit: true,
    clusterBonus: 46,
    supportObjectPriority: 8,
  },
  "living-barricade": {
    id: "living-barricade",
    engagementRadius: 172,
    maxPursuersPerTarget: 4,
    retargetSeconds: .74,
    routeCooldown: 1.32,
    routeSwitchMargin: 15,
    humanPursuit: true,
    durableTargetBonus: 24,
    supportObjectPriority: 28,
  },
  "vault-backline": {
    id: "vault-backline",
    engagementRadius: 330,
    maxPursuersPerTarget: 1,
    retargetSeconds: .26,
    routeCooldown: .56,
    routeSwitchMargin: 4,
  ...
  "mimic-taunt": {
    ...
    clusterBonus: 36,
    supportKindBonus: 30,
    supportObjectPriority: 10,
  },
  "projectile-canopy": {
    id: "projectile-canopy",
    engagementRadius: 190,
    maxPursuersPerTarget: 3,
    retargetSeconds: .62,
    routeCooldown: 1.18,
    routeSwitchMargin: 13,
    humanPursuit: true,
    forwardThreatWeight: .24,
    supportObjectPriority: 22,
  },
  "root-support": {
    id: "root-support",
    engagementRadius: 182,
    maxPursuersPerTarget: 2,
    retargetSeconds: .82,
    routeCooldown: 1.4,
    routeSwitchMargin: 16,
    humanPursuit: true,
    forwardThreatWeight: .12,
    supportObjectPriority: 36,
  },
});
