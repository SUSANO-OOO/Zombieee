...
export const V099_TIMELINE_AUDIO_CUES = Object.freeze([
  { id: "support-pod-inbound", category: "support", gain: 0.64, priority: 76, cooldownMs: 180, maxInstances: 2 },
  { id: "support-pod-landing-impact", category: "support", gain: 0.78, priority: 88, cooldownMs: 220, maxInstances: 2 },
  { id: "support-pod-activation", category: "support", gain: 0.68, priority: 80, cooldownMs: 260, maxInstances: 1 },
  { id: "support-pod-complete", category: "support", gain: 0.62, priority: 72, cooldownMs: 260, maxInstances: 1 },
...
export const V099_MANUAL_ABILITY_AUDIO_CONTRACTS = Object.freeze({
  ...
  medic: freezeContract({ readyCue: "ability-ready-support", activationRoot: "ability-medic-emergency-activate", timeline: { success: "support-heal" } }),
  ...
  kumaverson: freezeContract({ readyCue: "ability-ready-melee", activationRoot: "ability-kumaverson-iron-pan-activate", timeline: { stance: "ability-kumaverson-stance" } }),
  ...
  guardian: freezeContract({ readyCue: "ability-ready-support", activationRoot: "ability-guardian-shieldwall-activate", timeline: { hold: "support-barrier" } }),
  ...
  zakimiya: freezeContract({ readyCue: "ability-ready-ranged", activationRoot: "ability-zakimiya-molotov-activate", timeline: { throw: "ability-zakimiya-molotov-throw", impact: "support-explosion", burn: "corpse-ignite" } }),
  ...
  "mrs-chiha": freezeContract({ readyCue: "ability-ready-ranged", activationRoot: "ability-mrs-chiha-salvo-activate", timeline: { cylinder: "ability-mrs-chiha-salvo-cylinder", shot: "ability-mrs-chiha-salvo-shot", impact: "ability-mrs-chiha-salvo-impact", final: "ability-mrs-chiha-salvo-final" } }),
  ...
  "mayo-chan": freezeContract({ readyCue: "ability-ready-melee", activationRoot: "ability-mayo-feral-start", timeline: { rush: "ability-mayo-feral-rush", end: "ability-mayo-feral-end" } }),
});
