...
export const STORY_EVENTS = Object.freeze({
  intro: event("intro", "nishijin-night", [
    ...
    { speaker: "水城 奈々", role: "通信・地図・情報分析", side: "right", portrait: "guide", expression: "steady", text: "途中からです。最初だけは録音じゃない。" },
    ...
    { speaker: "白石 直人", role: "衛生兵", side: "right", portrait: "medic", expression: "steady", text: "医療品を積み直します。足りないかもしれない。" },
  ...
  "stage-nishijin-pre": event("stage-nishijin-pre", "shopping-street", [
    ...
    { speaker: "クレイジーキング", role: "狂戦士", side: "left", portrait: "crazy-king", expression: "ready", text: "チェーンソーは止めた。燃料がもったいない。" },
    ...
    { speaker: "橘 迅", role: "遊撃手", side: "right", portrait: "scout", expression: "focused", text: "あんた、名前は？" },
  ...
  "stage-nishijin-post": event("stage-nishijin-post", "shopping-street", [
    ...
    { speaker: "水城 奈々", role: "通信・地図・情報分析", side: "right", portrait: "guide", expression: "alert", text: "区役所の信号は続いています。道は開きました。" },
    { speaker: "大庭 豪", role: "破砕兵", side: "left", portrait: "brute", expression: "ready", text: "怪我人がいるなら行く。瓦礫は俺がどける。" },
  ...
  "stage-takuya-pre": event("stage-takuya-pre", "defense-line", [
    ...
    { speaker: "水城 奈々", role: "通信・地図・情報分析", side: "right", portrait: "guide", expression: "alert", text: "地下に大きな反応。上がってきます。" },
  ...
  "stage-takuya-post": event("stage-takuya-post", "defense-line", [
    { speaker: "水城 奈々", role: "通信・地図・情報分析", side: "right", portrait: "guide", expression: "relieved", text: "防衛線の感染反応、消えました。" },
