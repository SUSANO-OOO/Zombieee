...
export const STAGE_OBJECT_MANIFEST = Object.freeze({
  [STAGE_IDS.NISHIJIN]: Object.freeze({
    ...
    objects: Object.freeze([
      ...
      stageObject({ id: "nishijin-infection-node-active", stageId: STAGE_IDS.NISHIJIN, slot: "infection-node", state: "base-exposed", path: "/art/v060/stage-objects/nishijin-infection-node-active-v1.png", x: 850, y: 434, width: 128, z: 3, depthBand: "objective", collision: { width: 150, height: 300, lanes: [0, 1, 2] }, interactionX: 875 }),
      stageObject({ id: "nishijin-infection-node-destroyed", stageId: STAGE_IDS.NISHIJIN, slot: "infection-node", state: "base-destroyed", path: "/art/v060/stage-objects/nishijin-infection-node-destroyed-v1.png", x: 850, y: 434, width: 128, z: 3, depthBand: "objective", interactionX: 875 }),
    ]),
  }),
